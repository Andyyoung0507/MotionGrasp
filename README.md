...
<div align=center>
    <img src="./imgs/demo1.gif" width="250"/><img src="./imgs/demo2.gif" width="250"/><img src="./imgs/demo3.gif" width="250"/>
</div>
...
Please download the GraspNet-1Billion dataset for training. You can download it from the [official GitHub repository](https://graspnet.net/datasets.html).

Please ensure that your downloaded GraspNet-1Billion dataset follows the structure below:
...
```bash
cd dataset
python split_1billion.py --data_dir /data/GraspNet_1billion --test_dir /data/testset
```

You can set your dataset path by modifying the `data_dir` and `test_dir`.
`data_dir` denotes to the path of the original GraspNet-1Billion dataset.
`test_dir` denotes to the path where you want to save the processed testset.
